...
namespace SumEachColInMatrixInArray
{
    ...
    void FillArrayWithSumOfColsMatrix3_3(int Matrix[3][3], int ArraySum[3])
    {
        for (short i = 0; i < 3; i++)
        {
            ArraySum[i] = SumOfColInMatriw3_3(Matrix, i);
        }
    }
    ...
    void Run()
    {
        ...
        FillArrayWithSumOfColsMatrix3_3(Matrix, ArraySum);


        MyOutput::PrintArray(ArraySum, 3, "\nThe following are the Sum of each Col in the matrix :\n", "\n", "Col ", true, " Sum = ");
