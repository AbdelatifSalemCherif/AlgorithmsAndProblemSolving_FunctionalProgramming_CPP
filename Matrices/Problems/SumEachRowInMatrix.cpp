...
namespace SumEachRowInMatrix
{
    ...
    void PrintSumOfRawsMatrix3_3(int Matrix[3][3])
    {

        for (short i = 0; i < 3; i++)
        {
            cout << "Row " << i + 1 << " Sum = " << SumOfRowInMatriw3_3(Matrix, i) << endl;
        }
    }
    ...
    void Run()
    {
        ...
        PrintSumOfRawsMatrix3_3(Matrix);
