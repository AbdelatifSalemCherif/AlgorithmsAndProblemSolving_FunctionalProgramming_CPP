...
namespace CheckMatricesEquality
{
    ...
    bool CheckEquality2Matrices(int Matrix1[3][3], int Matrix2[3][3])
    {
        return SumOfMatrixElements(Matrix1) == SumOfMatrixElements(Matrix2);
    }
    ...
    void Run()
    {
        ...
        int Matrix1[3][3] = { {1,1,1},{2,4,2},{3,3,3} }, Matrix2[3][3] = { {3,1,1},{2,2,2},{3,3,3} };
        ...
        if (CheckEquality2Matrices(Matrix1, Matrix2))
        {
