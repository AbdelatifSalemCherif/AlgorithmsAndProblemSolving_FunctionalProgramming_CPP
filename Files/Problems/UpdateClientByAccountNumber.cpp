...
namespace UpdateClientByAccountNumber
{
    ...
    bool UpdateClientOnVector(vector <stBankClientRecord>& vClients, stBankClientRecord Client)
    {
        for (stBankClientRecord& C : vClients)
        {
    ...
    bool UpdateClientOnFile(string FileName, vector <stBankClientRecord>& vClients, string AccountNumber, string Separator)
    {
        stBankClientRecord Client = ReadBankClientRecord("\n\n", AccountNumber);

        if (UpdateClientOnVector(vClients, Client))
        {
