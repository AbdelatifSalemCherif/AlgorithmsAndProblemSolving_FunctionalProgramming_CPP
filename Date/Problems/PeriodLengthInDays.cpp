...
namespace PeriodLengthInDays
{
    ...
    int GetPeriodLengthInDays(sPeriod Period, bool IncludingEndDay = false)
    {
    ...
    void Run()
    {
        ...
        MyOutput::PrintNumber("Period Length (Including End Day) is : ", GetPeriodLengthInDays(Period, true), "\n");
