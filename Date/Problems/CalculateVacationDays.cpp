...
namespace CalculateVacationDays
{
    struct sDate
    {
        short Year;
    ...
    void Run()
    {
        ...
        PrintDate("\n\nVacation From : " + GetDayName(DayIndex(DateFrom)) + ", ", DateFrom, "\n");

        PrintDate("Vacation To : " + GetDayName(DayIndex(DateTo)) + ", ", DateTo, "\n");

        cout << "\nActual vacation Days is : " << GetActualVacationDays(DateFrom, DateTo) << endl;
